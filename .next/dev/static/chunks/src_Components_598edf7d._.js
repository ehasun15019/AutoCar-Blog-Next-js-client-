...
"[project]/src/Components/Design/TestimonialCardDesign.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/Components/Testimonial/Testimonial.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$Components$2f$Design$2f$TestimonialCardDesign$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/Components/Design/TestimonialCardDesign.jsx [app-client] (ecmascript)");
;
...
const Testimonial = ()=>{
    ...
    const [review, setReview] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(t0);
    let t1;
    let t2;
    if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = ()=>{
            fetch("/review.json").then(_temp).then((data)=>setReview(data)).catch(_temp2);
        };
        t2 = [];
        $[2] = t1;
        $[3] = t2;
...
//# sourceMappingURL=src_Components_598edf7d._.js.map