...
const AuthProvider = (t0)=>{
    ...
    if ($[0] !== "6ca9f32e87741ed595f423c3f459fa7c7844046ca56b50e25c2896ec10a78277") {
        for(let $i = 0; $i < 7; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "6ca9f32e87741ed595f423c3f459fa7c7844046ca56b50e25c2896ec10a78277";
    }
    const { children } = t0;
    const [user] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [loading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const createUserFunction = _temp;
    let t1;
    if ($[1] !== loading || $[2] !== user) {
        t1 = {
            user,
...
_s(AuthProvider, "HkJEZZaq10qd4UPMKJh2qDG9XBQ=");
_c = AuthProvider;
const __TURBOPACK__default__export__ = AuthProvider;
function _temp(email, password) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createUserWithEmailAndPassword"])(auth, email, password);
}
var _c;
...
//# sourceMappingURL=src_44f6fd8a._.js.map